# Screenshot Guide for acimig v2.0

## Required Screenshots

Capture the following screenshots after starting the Flask application.
...
3. Create a test fabric and upload sample data (optional)
...
- **What to capture**: Full page showing:
  ...
  - Fabric statistics or empty-state guidance
...
- **What to capture**: Full page showing:
  ...
  - Data table with sample data (if available)
- **Recommended size**: 1920x1080
